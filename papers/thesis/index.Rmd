...
abstract-text: |
  ...
  The change points are estimated using a segment likelihood function, which is
  ...
  segments of random variables with a common regrassion parameter, for which a
