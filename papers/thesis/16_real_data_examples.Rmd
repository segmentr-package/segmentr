...
the negative of the squared sum of residuals, the squared sum of residuals is a good candidate for our segment cost function.
...
parameters such the penalty function has a scale compatible with the cost
