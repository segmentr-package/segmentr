...
timetolerable by reducing the granularity of the data, getting the monthly averages for each of the the
...
has a unatractive likelihood, due to the presence of alternating trends. Because of this, the macro-segment
