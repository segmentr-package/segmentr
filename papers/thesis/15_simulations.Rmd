...
head(D) %>%
  kable(caption="(ref:sample-columns-caption)")
```
...
(ref:results-columns-caption) Segment tables as defined in \@ref(eq:examplecolumns).
...
segment(D, likelihood = penalized, algorithm = "exact") %>%
  print_results_table(caption="(ref:results-columns-caption)")
```
...
segment(D, likelihood = multivariate, algorithm = "exact") %>%
  print_results_table(caption="Results of segmentation usign a non-penalized multivariate likelihood")
```
...
X_10 & \sim \text{Bern}(0.1)
X_11 & \sim \text{Bern}(0.1)
X_12 & \sim \text{Bern}(0.1)
X_13 & \sim \text{Bern}(0.1)
X_14 & \sim \text{Bern}(0.1)
X_15 & \sim \text{Bern}(0.1)
X_16 & \sim \text{Bern}(0.9)
X_17 & \sim \text{Bern}(0.9)
X_18 & \sim \text{Bern}(0.9)
X_19 & \sim \text{Bern}(0.9)
X_20 & \sim \text{Bern}(0.9)
\end{aligned}
(\#eq:geneticexample)
\end{equation}
...
segment(
  ...
  print_results_table(caption="(ref:results-penalized-mean-caption)")
```
