...
In order to show compatibility with the work presented in [@base-paper], we analyze the
...
The answer provided by the `segment` package in that scenario would actually be
...
same type. This is of interest for a researching investigating diseases.
