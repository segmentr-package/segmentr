...
in the chapter is the cost function, it's, in essence, the bottleneck of the
...
likelihood function (used to calculate the cost) in compiled C++ programming
language, as well as it implements [r_multivariate()] which implements the same
algorithm in the R programming environment.
