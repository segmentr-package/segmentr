...
The package `microbenchmark` allows us to execute the code and compare different runtimes.
...
microbenchmark(
  segment(data, likelihood = multivariate, algorithm = "exact"),
  segment(data, likelihood = r_multivariate, algorithm = "exact"),
  segment(data, likelihood = multivariate, algorithm = "hierarchical"),
...
doMC::registerDoMC(4)
microbenchmark(
  segment(data, likelihood = multivariate, algorithm = "exact", allow_parallel = FALSE),
  segment(data, likelihood = multivariate, algorithm = "exact", allow_parallel = TRUE),
  segment(data, likelihood = multivariate, algorithm = "hierarchical", allow_parallel = FALSE),
  segment(data, likelihood = multivariate, algorithm = "hierarchical", allow_parallel = TRUE),
  times = 1
)
```
...
relies on the user after evaluating the nature of the dataset. For datasets with few samples
...
An alternative not developed in this project would be to use a genetic algorithm aproach to
