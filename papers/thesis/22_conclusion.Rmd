...
This work describes the segmentation problem, provides aa theorical model to work
...
algorithm to pick, and whether or not paralellization can help in running the computation
